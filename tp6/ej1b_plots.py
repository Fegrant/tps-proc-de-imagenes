...
# Let's look at our fish image the image it's ok in brg

bird = cv2.imread("imagenes/bird.jpg")
cv2.imwrite("results/birdbgr.jpg", bird)
...
hsv_nemo = cv2.cvtColor(bird, cv2.COLOR_BGR2HSV)
...
mask = cv2.inRange(hsv_nemo, light_blue, black)
